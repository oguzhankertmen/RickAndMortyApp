  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Character: GraphQLSelectionSet {
      ...
      public struct Result: GraphQLSelectionSet {
        ...
        public init(name: String? = nil, species: String? = nil, gender: String? = nil, image: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "Character", "name": name, "species": species, "gender": gender, "image": image])
        }
