...
struct CharacterListRowView_Previews: PreviewProvider {
    static var previews: some View {
        CharacterListRowView(character: CharacterModel(result: FetchAllCharactersQuery.Data.Character.Result?.init(FetchAllCharactersQuery.Data.Character.Result.init(name: "Pickle Rick", species: "Pickle", gender: "Male", image: "https://cdn.wannart.com/production/post/2018/09/https-blueprint-api-production.s3.amazonaws.com-uploads-card-image-559122-6a39f256-fa39-414b-a29c-a9b52bd9c049.png"))))
    }
}
